...
- Feature renderers should receive data and render only their domain UI. For example, `MinionChat` should accept a `Minion` and render chat messages without fetching data, reading stores, or knowing whether it is inside a panel, card, or page.
